...
struct AppData {
    ...
    static let person = Person(index: 0, id: 0, name: "", image: "", status: "", species: "", type: "", gender: "", url: "", origin: PersonOrigin(name: "", url: ""), location: PersonLocation(name: "", url: ""), episode: [])
    static let location = Location(id: 0, name: "", type: "", dimension: "", url: "", residents: [])
    static let episode = Episode(id: 0, name: "", date: "", episode: "", url: "", characters: [])
}
